/*!
 *   \file JetDictionary.cpp
 *   \brief Source file for fastjet class implementation in rootcling
 */
 // Do NOT change. Changes will be lost next time file is generated

#define R__DICTIONARY_FILENAME SourceFilesdIJetDictionary
...
namespace fastjet{class __attribute__((annotate("$clingAutoload$PseudoJet.hh")))  __attribute__((annotate("$clingAutoload$SourceFiles/headers/jetdict.h")))  PseudoJet;}
namespace std{template <typename _Tp> class __attribute__((annotate("$clingAutoload$bits/allocator.h")))  __attribute__((annotate("$clingAutoload$string")))  allocator;
}
namespace fastjet{class __attribute__((annotate("$clingAutoload$fastjet/PseudoJetStructureBase.hh")))  __attribute__((annotate("$clingAutoload$SourceFiles/headers/jetdict.h")))  PseudoJetStructureBase;}
)DICTFWDDCLS";
...
// Inline headers
#include "SourceFiles/headers/jetdict.h"
